    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fundingSourceType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DataAccessLayer.FundingSourceType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fundingSourcePropertyType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DataAccessLayer.FundingSourcePropertyType')),
                ('fundingSourceType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DataAccessLayer.FundingSourceType')),
            ],
            options={
                'abstract': False,
